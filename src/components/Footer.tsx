      ...
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6">
        <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-6">
          <div className="sm:col-span-2 md:col-span-2">
            <h3 className="font-display text-2xl font-bold">WTS <span className="font-normal">in</span> <span className="text-primary">Pakistan</span></h3>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-white/70">
              ...
              <li><Link to="/sell" className="hover:text-white">Sell on WTS in Pakistan</Link></li>
        ...
        <div className="mt-8 flex flex-col-reverse items-start justify-between gap-6 border-t border-white/15 pt-6 md:flex-row md:items-center">
          <p className="text-xs text-white/70">© {new Date().getFullYear()} WTS in Pakistan. All rights reserved.</p>
